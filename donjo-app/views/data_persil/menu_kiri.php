<div class="box box-info">
	...
	<div class="box-body no-padding">
		<ul class="nav nav-pills nav-stacked">
			...
			<li <?php if ($this->tab_ini == 13): ?>class="active"<?php endif; ?>><a href="<?= site_url('data_persil/persil')?>"><i class='fa fa-list'></i>Daftar Persil</a></li>
	...
	<div class="box-body no-padding">
		<ul class="nav nav-pills nav-stacked">
			<?php if ($persil_jenis): ?>
				...
				<?php endforeach;?>
			<?php endif; ?>
			<li <?php if ($this->tab_ini == 20): ?>class="active"<?php endif; ?>><a href="<?= site_url('data_persil/persil_jenis')?>"><i class='fa fa-plus'></i> Tambah Jenis Persil</a></li>
		</ul>
	</div>
</div>
<div class="box box-info">
